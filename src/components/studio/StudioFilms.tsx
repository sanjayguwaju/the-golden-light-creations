...
export function StudioFilms({
  ...
  return (
    <section id="films" className="bg-[#0A0A0A] py-20 sm:py-32 border-b border-white/5 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10 sm:mb-16">
          <div>
            ...
            <p className="font-poppins text-xs sm:text-sm text-white/70 max-w-xl mt-3 leading-relaxed">
      ...
      >
        {items.map((film) => (
          <div
            ...
            className="flex-[0_0_84vw] sm:flex-[0_0_420px] max-w-[420px] group relative bg-[#111111] border border-white/10 hover:border-[#F5B301]/60 overflow-hidden cursor-pointer transition-all duration-300 hover:-translate-y-2 snap-center shrink-0"
          >
            {/* Film Thumbnail */}
            <div className="relative aspect-[16/10] overflow-hidden">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full border-2 border-[#F5B301]/80 bg-[#0A0A0A]/60 backdrop-blur-sm flex items-center justify-center text-[#F5B301] group-hover:bg-[#F5B301] group-hover:text-[#0A0A0A] transition-all duration-300 group-hover:scale-110 shadow-xl">
            ...
            <div className="p-5 sm:p-6 bg-gradient-to-b from-transparent to-[#0A0A0A]">
              ...
              <h3 className="font-bebas text-xl sm:text-2xl tracking-[0.05em] text-white uppercase group-hover:text-[#F5B301] transition-colors leading-tight line-clamp-1">
                {film.title}
              </h3>
            </div>
          </div>
